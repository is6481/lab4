...
ggplot(density_data, aes(x=value)) + 
    geom_density(fill='#1C7C54',alpha=0.6) + 
...
This table shows, for example, that cluster 1 is very high on Milk and Fish, somewhat high on Eggs and Starch and very low on Fruits and Vegetables. We might name this cluster "The Seaside Diet" based on this profile.
